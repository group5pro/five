...
<div class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-5 hidden-xs">
                        <div class="header-top-left">
                            ...
                            <ul class="header-top-style pl-10">
                                <li>
                                    <span class="mr-10"><img alt="" src="/static/images/header/language/1-min.jpg"></span>
                                    <a href="#"><span class="mr-10">English</span><i class="fa fa-angle-down"></i></a>
                                    <ul class="ul-style language box-shadow white-bg">
                                        <li><a href="#"><img alt="" src="/static/images/header/language/1-min.jpg"><span>English</span></a></li>
                                        <li><a href="#"><img alt="" src="/static/images/header/language/2-min.jpg"><span>Germani</span></a></li>
                                        <li><a href="#"><img alt="" src="/static/images/header/language/3-min.jpg"><span>French</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-sm-4 col-xs-6">
                        <div class="header-top-right">
                            <span class="mr-20"><a href="#"><img alt="" src="/static/images/header/search-icon.png"></a></span>
                ...
                <div class="row header-middle-content">
                    <div class="col-md-5 col-sm-4 hidden-xs">
                        <div class="service-inner mt-10">
                                <span class="service-img b-img">
                                    <img alt="" src="/static/images/service.png">
                                </span>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12">
                        <div class="header-logo text-center">
                            <a href="index.html"><img alt="" src="/static/images/logo.png"></a>
                        </div>
                    </div>
                    <div class="col-md-offset-0 col-md-5 col-sm-offset-0 col-sm-4 col-xs-offset-3 col-xs-6">
                        <div class="shopping-cart">
                            ...
                            <ul class="shopping-cart-down box-shadow white-bg">
                                ...
                                <li class="media">
                                    <a href="#"><img alt="" src="/static/images/cart/2.jpg"></a>
                                    <div class="cart-item-wrapper">
                                ...
                                <li class="media">
                                    <a href="#"><img alt="" src="/static/images/cart/3.jpg"></a>
                                    <div class="cart-item-wrapper">
    ...
    <section class="slider-container">
        ...
        <div id="mainSlider" class="nivoSlider slider-image">
            <img src="/static/images/slider/1.jpg" alt="main slider" title="#htmlcaption1">
            <img src="/static/images/slider/2.jpg" alt="main slider" title="#htmlcaption2">
        </div>
        <!-- Slider Caption 1 -->
    ...
    <section id="page-content" class="page-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="why-us-inner">
                            <div class="why-us-icon mb-20">
                                <img src="/static/images/why-us/1.png" alt="">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="why-us-inner">
                            <div class="why-us-icon mb-20">
                                <img src="/static/images/why-us/2.png" alt="">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="why-us-inner">
                            <div class="why-us-icon mb-20">
                                <img src="/static/images/why-us/3.png" alt="">
                            </div>
                    ...
                    <div class="col-md-3 hidden-sm">
                        <div class="why-us-inner m-0">
                            <div class="why-us-icon mb-20">
                                <img src="/static/images/why-us/4.png" alt="">
                            </div>
                ...
                <div class="row rp-style">
                    <div class="col-sm-4 cp-style">
                        <div class="banner-inner">
                            <a class="test-popup-link banner-img" href="/static/images/banner/1.jpg">
                    ...
                    <div class="col-sm-8 cp-style">
                        <div class="row rp-style">
                            <div class="col-sm-8 cp-style">
                                <div class="banner-inner">
                                    <a class="test-popup-link banner-img" href="/static/images/banner/2.jpg">
                            ...
                            <div class="col-sm-4 cp-style">
                                <div class="banner-inner">
                                    <a class="test-popup-link banner-img" href="/static/images/banner/3.jpg">
                        ...
                        <div class="row rp-style mt-8">
                            <div class="col-sm-4 cp-style">
                                <div class="banner-inner">
                                    <a class="test-popup-link banner-img" href="/static/images/banner/4.jpg">
                                        <img src="/static/images/banner/4.jpg" alt="">
                                    </a>
                            ...
                            <div class="col-sm-8 cp-style">
                                <div class="banner-inner m-0">
                                    <a class="test-popup-link banner-img" href="/static/images/banner/5.jpg">
                                        <img src="/static/images/banner/5.jpg" alt="">
                                    </a>
                ...
                <div class="row rp-style">
                    <div class="col-md-12">
                        <div class="section-title text-center mb-35">
                            ...
                            <img alt="" src="/static/images/section-border.png">
                        </div>
                    </div>
                </div>
                <div class="row rp-style">
                    <div class="featured-carousel indicator-style">
                            ...
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img alt="" src="/static/images/product/arrival/1.jpg">
                                    </div>
                                </a>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img alt="" src="/static/images/product/arrival/2.jpg">
                                    </div>
                                </a>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img alt="" src="/static/images/product/arrival/3.jpg">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img alt="" src="/static/images/product/arrival/4.jpg">
                                    </div>
                                </a>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img alt="" src="/static/images/product/arrival/5.jpg">
                                    </div>
                                </a>
        ...
        <div class="offer-area">
            <div class="offer-banner banner-style-1 pull-left">
                <a href="#">
                    <img src="/static/images/offer/1.jpg" alt="">
                </a>
            ...
            <div class="offer-banner banner-style-2 pull-right">
                <a href="#">
                    <img alt="" src="/static/images/offer/2.jpg">
                </a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-up-comming ash-bg">
                            ...
                            <div class="product-inner pull-right">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/cuntdown/1.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="single-up-comming ash-bg">
                            ...
                            <div class="product-inner pull-right">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/cuntdown/2.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="col-md-4 hidden-sm">
                        <div class="single-up-comming ash-bg m-0">
                            ...
                            <div class="product-inner pull-right">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/cuntdown/3.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="featured-carousel indicator-style">
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/1.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase orang-bg">-20%</span>
                                <ul class="quick-veiw text-center">
                            ...
                            <div class="product-inner mt-35">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/2.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/3.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase black-bg">new</span>
                                <ul class="quick-veiw text-center">
                            ...
                            <div class="product-inner mt-35">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/4.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase orang-bg">-20%</span>
                                <ul class="quick-veiw text-center">
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/5.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                            ...
                            <div class="product-inner mt-35">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/6.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase black-bg">new</span>
                                <ul class="quick-veiw text-center">
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/7.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase orang-bg">-20%</span>
                                <ul class="quick-veiw text-center">
                            ...
                            <div class="product-inner mt-35">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/8.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="product-container cp-style-2">
                            <div class="product-inner">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/9.jpg" alt="">
                                    </div>
                                </a>
                                <ul class="quick-veiw text-center">
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                            ...
                            <div class="product-inner mt-35">
                                <a href="#">
                                    <div class="product-img b-img">
                                        <img src="/static/images/product/arrival/10.jpg" alt="">
                                    </div>
                                </a>
                                <span class="product-tag text-uppercase orang-bg">-20%</span>
                                <ul class="quick-veiw text-center">
        ...
        <div class="offer-banner-area section-padding clearfix">
            <figure class="single-offer-banner b-img">
                <img src="/static/images/offer-banner/1.jpg" alt="">
                <figcaption>
            ...
            <figure class="single-offer-banner b-img">
                <img src="/static/images/offer-banner/2.jpg" alt="">
                <figcaption>
                    <div class="figcation-text left-top text-uppercase text-left text-white">
                        <h1>WATCHES</h1>
                    </div>
            ...
            <figure class="single-offer-banner b-img m-0">
                <img src="/static/images/offer-banner/3.jpg" alt="">
                <figcaption>
                ...
                <div class="row">
                    <div class="col-md-6 cp-style-2">
                        <div class="section-title text-center mb-35">
                            ...
                            <img src="/static/images/section-border.png" alt="">
                        </div>
                                ...
                                <div class="best-product-inner mb-35 row rp-style-3 clearfix">
                                    <div class="col-xs-5 cp-style-3">
                                        <div class="best-product-img b-img b-img">
                                            <a href="#">
                                                <img src="/static/images/best-seller/2.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="best-product-inner row rp-style-3 clearfix">
                                    <div class="col-xs-5 cp-style-3">
                                        <div class="best-product-img b-img">
                                            <a href="#">
                                                <img src="/static/images/best-seller/3.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xs-7 cp-style-3">
                            ...
                            <div class="product-container">
                                <div class="best-product-inner mb-35 row rp-style-3 clearfix">
                                    <div class="col-xs-5 cp-style-3">
                                        <div class="best-product-img b-img">
                                            <a href="#">
                                                <img src="/static/images/best-seller/4.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xs-7 cp-style-3">
                                ...
                                <div class="best-product-inner row rp-style-3 clearfix">
                                    <div class="col-xs-5 cp-style-3">
                                        <div class="best-product-img b-img">
                                            <a href="#">
                                                <img src="/static/images/best-seller/1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xs-7 cp-style-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="blog-carousel indicator-style-two">
                            ...
                            <div class="single-blog blog-bg">
                                <div class="blog-img b-img">
                                    <a href="">
                                        <img alt="" src="/static/images/blog/2.jpg">
                                    </a>
                                </div>
                                <div class="blog-text p-20">
                                    <h4 class="text-uppercase text-defualt">
                            ...
                            <div class="testimonial-inner">
                                <div class="single-testimonial blog-bg mb-20">
                                    <div class="testimonial-img">
                                        <a href="#">
                                            <img src="/static/images/client/1.png" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="single-testimonial blog-bg">
                                    <div class="testimonial-img">
                                        <a href="#">
                                            <img src="/static/images/client/2.png" alt="">
                                        </a>
                                    </div>
                                    <div class="testimonial-content">
                                        <h5 class="text-uppercase text-defualt">THOMAS ALBERT,<span>Head of Ideas</span></h5>
                        ...
                        <div class="brand-carousel">
                            <div class="col-md-12">
                                <div class="single-brand text-center">
                                    <a href="#">
                                        <img src="/static/images/brand/1.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="single-brand text-center">
                                    <a href="#">
                                        <img src="/static/images/brand/2.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="single-brand text-center">
                                    <a href="#">
                                        <img src="/static/images/brand/3.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="single-brand text-center">
                                    <a href="#">
                                        <img src="/static/images/brand/4.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="single-brand text-center">
                                    <a href="#">
                                        <img src="/static/images/brand/5.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="single-footer-inner">
                            ...
                            <ul class="footer-contact">
                                <li class="contact-icon">
                                    <img alt="" src="/static/images/footer/icon/1.png">
                                </li>
                            ...
                            <ul class="footer-contact">
                                <li class="contact-icon">
                                    <img alt="" src="/static/images/footer/icon/2.png">
                                </li>
                                <li class="footer-text text-ash">
                            ...
                            <ul class="footer-contact">
                                <li class="contact-icon">
                                    <img alt="" src="/static/images/footer/icon/3.png">
                                </li>
                                <li class="footer-text text-ash">
                        ...
                        <div class="tweet-list">
                            <ul class="left-tweet">
                                <li class="tweet-inner clearfix">
                                    <div class="tweet-img">
                                        <a href="#">
                                            <img alt="" src="/static/images/footer/tweet/1.jpg">
                                        </a>
                                    </div>
                                ...
                                <li class="tweet-inner clearfix">
                                    <div class="tweet-img">
                                        <a href="#">
                                            <img alt="" src="/static/images/footer/tweet/2.jpg">
                                        </a>
                                    </div>
                                    <div class="tweet-text">
                                        <a href="#">Forge is the best ecommerce elt</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="payment-method b-img">
                            <img alt="" src="/static/images/footer/footer-bottom.png">
                        </div>
                    </div>
                </div>
            </div>
